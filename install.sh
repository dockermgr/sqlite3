...
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/sqlite3"
APPVERSION="$(__appversion "$REPO/raw/${GIT_REPO_BRANCH:-main}/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="sqlite3"
INSTDIR="$HOME/.local/share/dockermgr/sqlite3"
APPDIR="$HOME/.local/share/srv/docker/sqlite3"
DATADIR="$HOME/.local/share/srv/docker/sqlite3/files"
...
HUB_URL="casjaysdevdocker/sqlite3:latest"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
if [ -z "$HUB_URL" ] || [ "$HUB_URL" = "hello-world" ] || echo "$HUB_URL" | grep -q "sqlite3"; then
